// keel/hull form controls — Tailwind. GitLab @gitlab/ui control tokens: an inset field face with a
// strong border, and a focus that lifts the border to a high-contrast neutral + a blue outer ring.
